...
const Mercury = () => {
    ...
    return (
        ...
        <Header/>
        <header>
            <h1 className="bg-green-200 text-black mt-14"><marquee behavior="scroll" direction="left"><bold>The planet where it's so hot you'll melt, and so cold you'll freeze-The ultimate weather rollercoaster of the solar system.</bold></marquee></h1>
        </header>
