...
const Jupiter = () => {
  ...
  return (
    <>
      ...
      <div className="flex pt-8 bg-black">
            ...
            <div className="w-2/3 flex items-center flex-col">
                <h1 class= "text-3xl pb-3 text-white">Jupiter</h1> 
        ...
        <div className="px-32 bg-black">
            ...
            <h1 class="text-3xl text-center text-white mt-9 pb-5 justify-center">Satellite of Jupiter</h1>
