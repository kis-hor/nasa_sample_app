...
const Uranus = () => {
    ...
    return(
        ...
        <img className="object-cover h-56 w-auto mx-auto" src="https://i0.wp.com/i.pinimg.com/originals/50/92/3e/50923e1764ad4fdc3c6ff32e2aaa122d.gif?w=696&ssl=1" alt="Uranus" />
